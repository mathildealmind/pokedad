...
async function main(): Promise<void> {
  console.log("");
  console.log(
    "PokéDad – opret komplette EX Series-filer"
  );
  console.log(
    "=============================================="
  );
  ...
  console.log("");
  console.log(
    "✅ Alle 16 EX Series-filer er oprettet."
  );
  console.log("");
  console.log(
...
main().catch(
  (error: unknown) => {
    console.error("");
    console.error(
      "❌ EX Series-filerne kunne ikke oprettes."
    );
    console.error("");
