...
async function main(): Promise<void> {
  console.log("");
  console.log(
    "PokéDad – opret komplette E-Card-filer"
  );
  console.log(
    "============================================"
  );
  ...
  console.log("");
  console.log(
    "✅ Alle tre E-Card-filer er oprettet."
  );
  console.log("");
  console.log(
...
main().catch(
  (error: unknown) => {
    console.error("");
    console.error(
      "❌ E-Card-filerne kunne ikke oprettes."
    );
    console.error("");
