...
const SETS: SetDefinition[] = [
  ...
  },
  {
    ...
    exportName: "mysteriousTreasures",
...
async function main(): Promise<void> {
  console.log("");
  console.log(
    "PokéDad – opret komplette Diamond & Pearl-filer"
  );
  console.log(
    "===================================================="
  );
  ...
  console.log("");
  console.log(
    "✅ Alle 7 Diamond & Pearl-filer er oprettet."
  );
  console.log("");
  console.log(
...
main().catch(
  (error: unknown) => {
    console.error("");
    console.error(
      "❌ Diamond & Pearl-filerne kunne ikke oprettes."
    );
    console.error("");
