...
const SETS: SetDefinition[] = [
  {
    ...
    exportName: "heartGoldSoulSilverBase",
...
async function main(): Promise<void> {
  console.log("");
  console.log(
    "PokéDad – opret komplette HeartGold & SoulSilver-filer"
  );
  console.log(
    "=========================================================="
  );
  ...
  console.log("");
  console.log(
    "✅ Alle 5 HeartGold & SoulSilver-filer er oprettet."
  );
  console.log("");
  console.log(
...
main().catch(
  (error: unknown) => {
    console.error("");
    console.error(
      "❌ HeartGold & SoulSilver-filerne kunne ikke oprettes."
    );
    console.error("");
